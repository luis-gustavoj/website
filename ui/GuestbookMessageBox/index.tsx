...
const SubmitButton = () => {
  ...
  return (
    <button
      type="submit"
      className="bg-zinc-50 text-zinc-900 px-2 rounded-lg font-medium disabled:opacity-50"
      disabled={pending}
    >
...
export const GuestbookMessageBox = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-lg p-[1.5px]">
      <span className="absolute min-h-screen inset-[-1000%] animate-[spin_20s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#bbbbbe_0%,#9f9fa8_50%,#bbbbbe_100%)] dark:bg-[conic-gradient(from_90deg_at_50%_50%,#27272A_0%,#71717a_50%,#27272A_100%)]" />
